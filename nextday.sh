...
# Git makes a branch for each day
git co main
git switch day${1} 2>/dev/null || git switch -c day${1};

# creates the daily header file, and updates it
...
# creates the daily source file, and updates it.
